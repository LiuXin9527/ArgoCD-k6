...
export default function () {
    ...
    group('Should return 2001 with result approved', () => {
    ...
    group('Should return 2002 with result approved', () => {
        const sellerId = 500001919;
        const res = http.get(`${baseUrl}/merchant/status/${sellerId}`, params);
    ...
    group('Should return 2001 with result not registered', () => {
        const sellerId = -1;
        const res = http.get(`${baseUrl}/merchant/status/${sellerId}`, params);
    ...
    group('Should return 200 with result not registered', () => {
        const sellerId = -1;
        const res = http.get(`${baseUrl}/merchant/status1/${sellerId}`, params);
...
export function handleSummary(data) {
    ...
    return {
        '/k6-scripts/report/lcp-merchant-report.json': JSON.stringify(metricsJson),
